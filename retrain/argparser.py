...
def create_arg_parser():
    ...
    parser.add_argument('--results_dir', type=str, default='/Users/sperdijk/Documents/Master/Jaar_3/Thesis/thesis_code/retrain/results')
    parser.add_argument('--data_dir', type=str, 
                        default='/Users/sperdijk/Documents/Master/Jaar_3/Thesis/thesis_code/reduce_grammar/corpora/normal')
    ...
    parser.add_argument('--per_device_train_batch_size', type=int, default=48)
