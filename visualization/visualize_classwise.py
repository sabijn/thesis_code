...
# plot all classes in the same lot
plt.plot(class0, label=f'class PCT')
plt.plot(class1, label=f'class B')
plt.plot(class2, label=f'class I')
plt.plot(class3, label=f'class S')
plt.plot(class4, label=f'class E')

plt.legend()
plt.xlabel('Layer')
plt.ylabel('Accuracy')
plt.title('Accuracy per class for chunking task (testset).')
plt.savefig(home_path / Path('results/chunking_class_testset.png'))