...
def lowest_phrase_above_leaf_i(i, tree, return_target_ga=False):
    ...
    if not (label.split('-')[0].endswith('P') or label.split('-')[0] in ['S', 'ATSBAR', 'ATSQ', 'ATINTJ', 'ATS', 'SQ', 'SBAR', 'SBARQ', 'SINV', 
...
if __name__=='__main__':
    ...
    parser.add_argument('--text_toks', default=Path('/Users/sperdijk/Documents/Master/Jaar_3/Thesis/PTB/penn-sentences.txt')) 
    parser.add_argument('--bies_labels', default=Path('/Users/sperdijk/Documents/Master/Jaar_3/Thesis/thesis_code/data/bies_labelsPTB.txt')) 
